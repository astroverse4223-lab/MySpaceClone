...
-- AlterTable
ALTER TABLE "CommentReaction" ADD COLUMN     "emoji" TEXT NOT NULL DEFAULT '❤️';

-- AlterTable
ALTER TABLE "Profile" ADD COLUMN     "cursorEffect" TEXT,
ADD COLUMN     "glitter" BOOLEAN NOT NULL DEFAULT false,
